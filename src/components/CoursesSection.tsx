...
const groupBundles = [
  { name: "Group 1 — Full Bundle", subjects: "Physics, Electrical, PPS, EVS, Maths", bestValue: true },
  { name: "Group 2 — Full Bundle", subjects: "Chemistry, Electronics, Soft Skills, Mechanics, Maths", bestValue: false },
];

const singleSubjects = [
  "Physics", "Electrical Engineering", "PPS (Programming for Problem Solving)",
  "Environmental Science (EVS)", "Mathematics", "Chemistry",
  "Electronics Engineering", "Soft Skills", "Mechanics (Engineering Mechanics)",
];
      ...
      <div className="container relative mx-auto px-6">
        <AnimatedSection>
          ...
          <p className="mx-auto mt-4 max-w-2xl text-center text-muted-foreground">
            Pick a full group bundle at ₹500 or enroll in any single subject for just ₹150. No hidden fees.
          </p>
        </AnimatedSection>
              ...
              {groupBundles.map((bundle, i) => (
                <motion.div
                  ...
                  className={`relative rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1 ${
                    bundle.bestValue ? "glass-glow border-2 border-primary/40" : "glass"
                  }`}
                >
                  {bundle.bestValue && (
                    <span className="absolute -top-3 left-6 rounded-full bg-primary px-4 py-1 text-xs font-bold text-primary-foreground shadow-lg shadow-primary/30">Best Value</span>
                  )}
                  <span className="inline-block rounded-full bg-primary/15 px-4 py-1 text-xs font-bold uppercase tracking-wider text-primary">Group Bundle — 5 Subjects</span>
          ...
          <div className="mt-14">
            ...
            <div className="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {singleSubjects.map((subject, i) => (
                ...
                >
                  <span className="inline-block rounded-full bg-accent/15 px-4 py-1 text-xs font-bold uppercase tracking-wider text-accent">Single Subject</span>
